...
#   line 8
create_clock -name wb_clk -period 2 -waveform {0 1} [get_ports {wb_clk}]
# Warning: Libcell power domain derates are skipped!

set_clock_uncertainty -setup 0.3 [get_clocks {wb_clk}]
set_clock_transition 0.2 [get_clocks {wb_clk}]
